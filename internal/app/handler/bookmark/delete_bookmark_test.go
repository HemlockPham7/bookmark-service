...
func TestBookmarkHandler_DeleteBookmarkByID(t *testing.T) {
	t.Parallel()
	...
	testCases := []struct {
		...
		{
			name: "successful delete bookmark by ID",

			setupRequest: func(ctx *gin.Context) {
				setupDeleteBookmarkRequest(ctx, "d7c13097-67a7-4eae-a60e-0b9b533b7bd6", true)
			},

			setupMockSvc: func(ctx *gin.Context) *mock_bookmark.Service {
				mockService := mock_bookmark.NewService(t)
				mockService.On("DeleteBookmarkByID", ctx, "d7c13097-67a7-4eae-a60e-0b9b533b7bd4", "d7c13097-67a7-4eae-a60e-0b9b533b7bd6").
					Return(nil)
				return mockService
			},
		...
		},
		{
			...
			setupRequest: func(ctx *gin.Context) {
				setupDeleteBookmarkRequest(ctx, "d7c13097-67a7-4eae-a60e-0b9b533b7bd6", false)
			},
		...
		},
		{
			...
			setupRequest: func(ctx *gin.Context) {
				setupDeleteBookmarkRequest(ctx, "", true)
			},
...
func setupDeleteBookmarkRequest(ctx *gin.Context, bookmarkID string, haveClaim bool) {
